...
export default function Home() {
  ...
  return (
    <div >
        <Navbar/>
        <div className='flex flex-col justify-center w-full h-full pt-16 bg-gradient-to-br from-black to-gray-500 lg:h-[97vh] lg:w-[100vw] lg:flex lg:pt-0 lg:justify-between lg:flex-row'>
          <div className='order-2 w-[100%] lg:order-1 mt-5 lg:mt-24 lg:text-gray-400'>
